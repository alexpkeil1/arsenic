...
%LET mcobs = 100000;*Number of MC samples to take;
...
PROC EXPORT DATA = sim_lo_changes
 OUTFILE ="Z:/EpiProjects/MT_copper_smelters/output/GFORMULA_kmpics/gformula_lo_exposure_at_work.csv" DBMS=csv REPLACE; RUN;
PROC EXPORT DATA = sim_med_changes
 OUTFILE ="Z:/EpiProjects/MT_copper_smelters/output/GFORMULA_kmpics/gformula_med_exposure_at_work.csv" DBMS=csv REPLACE; RUN;
