...
* Data in: /nas02/home/a/k/akeil/EpiProjects/MT_copper_smelters/data/mtcs_an02.sas7bdat
* Data out:
* Description: 
* Keywords:
...
%INCLUDE "/nas02/home/a/k/akeil/EpiProjects/MT_copper_smelters/code/mtcs_import_20140828.sas";
PROC DATASETS LIB=work KILL;QUIT;
%INCLUDE "/nas02/home/a/k/akeil/EpiProjects/MT_copper_smelters/code/mtcs_cleaning_20140828.sas";
PROC DATASETS LIB=work KILL;QUIT;
%INCLUDE "/nas02/home/a/k/akeil/EpiProjects/MT_copper_smelters/code/mtcs_lagdata_201492.sas";
*/
...
PROC EXPORT DATA = anlast
 OUTFILE ="/nas02/home/a/k/akeil/EpiProjects/MT_copper_smelters/output/GFORMULA_kmpics/gformula_observed.csv" DBMS=csv REPLACE; RUN;
PROC EXPORT DATA = sim_nc_changes 
 OUTFILE ="/nas02/home/a/k/akeil/EpiProjects/MT_copper_smelters/output/GFORMULA_kmpics/gformula_natcourse.csv" DBMS=csv REPLACE; RUN;
PROC EXPORT DATA = sim_ne_changes
 OUTFILE ="/nas02/home/a/k/akeil/EpiProjects/MT_copper_smelters/output/GFORMULA_kmpics/gformula_no_exposure_at_work.csv" DBMS=csv REPLACE; RUN;
PROC EXPORT DATA = sim_al_changes
 OUTFILE ="/nas02/home/a/k/akeil/EpiProjects/MT_copper_smelters/output/GFORMULA_kmpics/gformula_hi_exposure_at_work.csv" DBMS=csv REPLACE; RUN;
*/
